...
def sharpe_ratio(start,end,coin1,coin2,coin3='bitcoin',coin4='ethereum',coin5='xrp'):
    ...
    if coin4 == coin1 or coin4 == coin3:
        coin4 = 'cardano'   # Replace with backup coin
    if coin5 == coin1 or coin5 == coin3 or coin5 == coin4:
